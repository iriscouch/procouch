...
if(process.argv[1] === module.filename) {
  var argv = require('optimist').demand(['db'])
                                .default('age', 3 * 60 * 1000) // 3 minutes in ms
                                .default('seq', 100)
                                .argv;
  return exports.heat.apply({}, [argv]);
}
